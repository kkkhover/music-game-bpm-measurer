...
> 版本：**主程序 v0.8.15** / 内置侧栏 **v0.8.12**（两侧版本号各自独立）
...
- 🡒 **安装包** `BPM 测速助手 Setup 0.8.15.exe`（免安装版请下载后解压）
...
osu-maphelper_v0.8.12/                    osu! 制谱侧栏源码（零第三方运行时依赖）
...
│
├─ 软件\
│   ├─ BPM 测速助手 Setup 0.8.15.exe   ← 安装包（可选安装目录、建快捷方式）
